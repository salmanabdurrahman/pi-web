...
app/api/
  ...
  skills/install/route.ts         POST install skills through bunx skills add
...
lib/
  ...
  npx.ts               bunx/npx runner used by skill install (prefers bunx)
...
- `/api/skills/install` shells through `bunx skills add ... --agent pi`; project installs run with the selected cwd.
