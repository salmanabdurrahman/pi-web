...
const { buildSkillUpdateArgs, checkSkillUpdate, checkSkillUpdates, skillUpdateKey } =
...
test("compares a project lock version with the skills.sh snapshot", async () => {
  ...
  assert.equal(requestedUrl, "https://skills.test/api/download/owner/repo/example-skill");
});
